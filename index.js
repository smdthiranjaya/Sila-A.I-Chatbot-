...
//=============================================
const channel_id = "888138145915359242"
//=============================================
...
client.on('message', async (message) => {
  ...
  let res = await axios.get(`http://api.brainshop.ai/get?bid=164509&key=ZRqH6fjufavGclsN&uid=[uid]&msg=${encodeURIComponent(message.content)}`);
